...
import { isValidLinkedInUrl, pauseFor } from "@/lib/utils";
          ...
          <Grid container spacing={2} alignItems="center" sx={{ pt: "1px" }}>
            ...
            >
              <Button
                ...
                sx={{
                  border:
                    selectedGoalDays === 30 ? "1px solid #38ACE2" : "none",
              ...
              <Button
                ...
                sx={{
                  border:
                    selectedGoalDays === 60 ? "1px solid #38ACE2" : "none",
              ...
              <Button
                ...
                sx={{
                  border:
                    selectedGoalDays === 90 ? "1px solid #38ACE2" : "none",
